...
void step_beta_stride1(RPR f, component c, const RPR g, const grid_volume &gv, const ivec is, const ivec ie,
...
void step_bfast_stride1(RPR f, component c, const RPR g1, const RPR g2, ptrdiff_t s1,
                ptrdiff_t s2, // strides for g1/g2 shift
                const grid_volume &gv, const ivec is, const ivec ie, realnum dtdx, direction dsig,
                const RPR sig, const RPR kap, const RPR siginv, RPR fu, direction dsigu,
                const RPR sigu, const RPR kapu, const RPR siginvu, realnum dt, const RPR cnd,
...
void step_update_EDHB_stride1(RPR f, component fc, const grid_volume &gv, const ivec is, const ivec ie,
