...
class mode_solver(object):
    ...
    def material_epsmu(self, material, epsmu, epsmu_inv, epsflag=True):
        return _mpb.mode_solver_material_epsmu(self, material, epsmu, epsmu_inv, epsflag)

    def mean_epsmu(self, meps, meps_inv, n, d1, d2, d3, tol, r, epsflag):
        return _mpb.mode_solver_mean_epsmu(self, meps, meps_inv, n, d1, d2, d3, tol, r, epsflag)
