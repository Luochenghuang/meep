...
def _get_farfield(f, v, greencyl_tol):
    return _meep._get_farfield(f, v, greencyl_tol)

def _get_farfields_array(n2f, where, resolution, greencyl_tol):
    return _meep._get_farfields_array(n2f, where, resolution, greencyl_tol)
...
class volume_list(object):
    ...
    cc = property(_meep.volume_list_cc_get, _meep.volume_list_cc_set)
...
class material_function(object):
    ...
    def is_thread_safe(self):
        return _meep.material_function_is_thread_safe(self)
...
class structure_chunk(object):
    ...
    def get_chi1inv_at_pt(self, arg2, arg3, idx, frequency=0, is_frequency_dependent=None):
        return _meep.structure_chunk_get_chi1inv_at_pt(self, arg2, arg3, idx, frequency, is_frequency_dependent)

    def get_chi1inv(self, arg2, arg3, iloc, frequency=0, is_frequency_dependent=None):
        return _meep.structure_chunk_get_chi1inv(self, arg2, arg3, iloc, frequency, is_frequency_dependent)
...
class dft_flux(object):
    ...
    def complexflux(self):
        return _meep.dft_flux_complexflux(self)
    ...
    def invalidate_eigenmode_cache(self):
        return _meep.dft_flux_invalidate_eigenmode_cache(self)
    ...
    eigenmode_cache = property(_meep.dft_flux_eigenmode_cache_get, _meep.dft_flux_eigenmode_cache_set)
    eigenmode_cache_dispersive = property(_meep.dft_flux_eigenmode_cache_dispersive_get, _meep.dft_flux_eigenmode_cache_dispersive_set)
    eigenmode_cache_frequency = property(_meep.dft_flux_eigenmode_cache_frequency_get, _meep.dft_flux_eigenmode_cache_frequency_set)
...
class dft_near2far(object):
    ...
    def farfield(self, x, greencyl_tol=1e-3):
        return _meep.dft_near2far_farfield(self, x, greencyl_tol)

    def farfield_lowlevel(self, F, x, greencyl_tol=1e-3):
        return _meep.dft_near2far_farfield_lowlevel(self, F, x, greencyl_tol)

    def get_farfields_array(self, where, rank, dims, N, resolution, greencyl_tol=1e-3):
        return _meep.dft_near2far_get_farfields_array(self, where, rank, dims, N, resolution, greencyl_tol)

    def save_farfields(self, fname, prefix, where, resolution, greencyl_tol=1e-3):
        return _meep.dft_near2far_save_farfields(self, fname, prefix, where, resolution, greencyl_tol)
    ...
    def near_sourcedata(self, x_0, farpt_list, nfar_pts, dJ, greencyl_tol):
        return _meep.dft_near2far_near_sourcedata(self, x_0, farpt_list, nfar_pts, dJ, greencyl_tol)
...
class fields(object):
    ...
    bfast_scaled_k = property(_meep.fields_bfast_scaled_k_get, _meep.fields_bfast_scaled_k_set)
    ...
    def get_eigenmode(self, frequency, d, where, eig_vol, band_num, kpoint, match_frequency, parity, resolution, eigensolver_tol, kdom=None, user_mdata=None, dp=None, cache_dispersive=None, cache_frequency=None):
        return _meep.fields_get_eigenmode(self, frequency, d, where, eig_vol, band_num, kpoint, match_frequency, parity, resolution, eigensolver_tol, kdom, user_mdata, dp, cache_dispersive, cache_frequency)

    def populate_maxwell_dielectric(self, mdata, mesh_size, R, G, s, o, frequency):
        return _meep.fields_populate_maxwell_dielectric(self, mdata, mesh_size, R, G, s, o, frequency)
...
class geom_epsilon(material_function):
    ...
    def is_thread_safe(self):
        return _meep.geom_epsilon_is_thread_safe(self)
    has_user_materials = property(_meep.geom_epsilon_has_user_materials_get, _meep.geom_epsilon_has_user_materials_set)
